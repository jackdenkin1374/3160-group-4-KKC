...
* Persons can rate drivers based on delivery time, courteousness, if the order is in good condition when delivered and a short review.
* Persons can rate restaurants based on quality of food, food options, order accuracy and a short review.
